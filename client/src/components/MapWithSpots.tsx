...
export default function MapWithSpots({ onSpotClick }: Props) {
  ...
  const boxMappings = [
    ...
    {
      spotName: "萊爾富側邊路邊停車格D_A區",     
      point: { lat: 25.013367, lng: 121.543109 },
      iconUrl: "", 
      rects: [
        {
          name: "D01",
          coords: [
            { lat: 25.013297, lng: 121.542986 },
            { lat: 25.013377, lng: 121.543112 },
            { lat: 25.013410, lng: 121.543087 },
            { lat: 25.013331, lng: 121.542962 },
          ],
          label: { lat: 25.013390, lng: 121.543020 },
        ...
        },
        {
          ...
          coords: [
            { lat: 25.013377, lng: 121.543112 },
            { lat: 25.013457, lng: 121.543238 },
            { lat: 25.013490, lng: 121.543213 },
            { lat: 25.013410, lng: 121.543087 },
          ],
          label: { lat: 25.013470, lng: 121.543146 },
          pano:  { lat: 25.013540, lng: 121.543328 }
        },
      ],
    },
    {
      spotName: "萊爾富側邊路邊停車格D_B區",     
      point: { lat: 25.013576, lng: 121.543429 },
      iconUrl: "", 
      rects: [
        {
          name: "D03",
          coords: [
            { lat: 25.013457, lng: 121.543238 },
            { lat: 25.013537, lng: 121.543364 },
            { lat: 25.013570, lng: 121.543339 },
            { lat: 25.013490, lng: 121.543213 }
          ],
          label: { lat: 25.013550, lng: 121.543272 },
          pano:  { lat: 25.013540, lng: 121.543328 }
        },
        {
          name: "D04",
          coords: [
            { lat: 25.013537, lng: 121.543364 },
            { lat: 25.013617, lng: 121.543490 },
            { lat: 25.013650, lng: 121.543465 },
            { lat: 25.013570, lng: 121.543339 }
          ],
          label: { lat: 25.013630, lng: 121.543398 },
          pano:  { lat: 25.013540, lng: 121.543328 }
        },
        {
          name: "D05",
          coords: [
            { lat: 25.013617, lng: 121.543490 },
            { lat: 25.013697, lng: 121.543616 },
            { lat: 25.013730, lng: 121.543591 },
            { lat: 25.013650, lng: 121.543465 }
          ],
          label: { lat: 25.013710, lng: 121.543524 },
          pano:  { lat: 25.013540, lng: 121.543328 }
        },
      ],
    },
    ...
    {
      spotName: "萊爾富側邊路邊停車格F_A區",     
      point: { lat: 25.013401, lng: 121.543211 }, 
      iconUrl: "", 
      rects: [
        {
          name: "F01",
          coords: [
            ...
            { lat: 25.013354, lng: 121.543130 },
            { lat: 25.013331, lng: 121.543149 },
            { lat: 25.013278, lng: 121.543067 }, 
          ],
          label: { lat: 25.013290, lng: 121.543130 },
        ...
        },
        {
          ...
          coords: [
            { lat: 25.013354, lng: 121.543130 }, 
            { lat: 25.013406, lng: 121.543211 },
            { lat: 25.013383, lng: 121.543230 },
            { lat: 25.013331, lng: 121.543149 }, 
          ],
          label: { lat: 25.013342, lng: 121.543211 },
          pano:  { lat: 25.013562, lng: 121.543483 } 
        },
        {
          name: "F03",
          coords: [
            { lat: 25.013406, lng: 121.543211 }, 
            { lat: 25.013458, lng: 121.543292 },
            { lat: 25.013435, lng: 121.543311 },
            { lat: 25.013383, lng: 121.543230 }, 
          ],
          label: { lat: 25.013394, lng: 121.543292 },
          pano:  { lat: 25.013562, lng: 121.543483 } 
        },
        {
          name: "F04",
          coords: [
            { lat: 25.013458, lng: 121.543292 },
            { lat: 25.013510, lng: 121.543373 },
            { lat: 25.013487, lng: 121.543392 },
            { lat: 25.013435, lng: 121.543311 },
          ],
          label: { lat: 25.013446, lng: 121.543373 },
          pano:  { lat: 25.013562, lng: 121.543483 } 
        },
      ],
    },
    {
      spotName: "萊爾富側邊路邊停車格F_B區",     
      point: { lat: 25.013606, lng: 121.543535 }, 
      iconUrl: "", 
      rects: [
        {
          name: "F05",
          coords: [
            { lat: 25.013509, lng: 121.543374 }, 
            { lat: 25.013560, lng: 121.543456 },
            { lat: 25.013539, lng: 121.543473 },
            { lat: 25.013487, lng: 121.543392 }, 
          ],
          label: { lat: 25.013498, lng: 121.543454 },
          pano:  { lat: 25.013562, lng: 121.543483 } 
        },
        {
          name: "F06",
          coords: [
            { lat: 25.013560, lng: 121.543456 },
            { lat: 25.013611, lng: 121.543537 },
            { lat: 25.013591, lng: 121.543554 },
            { lat: 25.013539, lng: 121.543473 },
          ],
          label: { lat: 25.013550, lng: 121.543535 },
          pano:  { lat: 25.013562, lng: 121.543483 } 
        },
        {
          name: "F07",
          coords: [
            { lat: 25.013611, lng: 121.543537 },
            { lat: 25.013662, lng: 121.543618 },
            { lat: 25.013643, lng: 121.543635 },
            { lat: 25.013591, lng: 121.543554 },
          ],
          label: { lat: 25.013602, lng: 121.543616 },
          pano:  { lat: 25.013562, lng: 121.543483 } 
        },
        {
          name: "F08",
          coords: [
            { lat: 25.013662, lng: 121.543618 },
            { lat: 25.013715, lng: 121.543700 },
            { lat: 25.013695, lng: 121.543716 },
            { lat: 25.013643, lng: 121.543635 },
          ],
          label: { lat: 25.013654, lng: 121.543697 },
          pano:  { lat: 25.013562, lng: 121.543483 } 
        },
      ],
    },
    {
      spotName: "萊爾富側邊路邊停車格F_C區",     
      point: { lat: 25.013768, lng: 121.543785 }, 
      iconUrl: "", 
      rects: [
        {
          name: "F09",
          coords: [
            { lat: 25.013715, lng: 121.543700 }, 
            { lat: 25.013779, lng: 121.543797 },
            { lat: 25.013759, lng: 121.543813 },
            { lat: 25.013695, lng: 121.543716 }, 
          ],
          label: { lat: 25.013706, lng: 121.543778 },
          pano:  { lat: 25.013562, lng: 121.543483 } 
        },
        {
          name: "F10",
          coords: [
            ...
            { lat: 25.013824, lng: 121.543911 },
            { lat: 25.013759, lng: 121.543813 }, 
          ],
          label: { lat: 25.013768, lng: 121.543869 },
          pano:  { lat: 25.013562, lng: 121.543483 } 
        },
      ],
    },
