...
export default function MapWithSpots({ onSpotClick }: Props) {
  ...
  },
  {
    ...
    point: { lat: 25.015382, lng: 121.542848 }, 
    iconUrl:"", // "https://cdn-icons-png.flaticon.com/512/608/608690.png",
    rects: [
      {
        name: "A01",
  ...
  },
  {
    ...
    point: { lat: 25.015482, lng: 121.542815 }, 
    iconUrl:"", // "https://cdn-icons-png.flaticon.com/512/608/608690.png",
    rects: [
      {
        name: "B01",
        coords: [
          { lat: 25.015542, lng: 121.542773 },
          { lat: 25.015424, lng: 121.542863 },
          { lat: 25.015451, lng: 121.542898 },
          { lat: 25.015569, lng: 121.542808 },
        ],
        label: { lat: 25.015516, lng: 121.542875 },
        pano:  { lat: 25.015483, lng: 121.542818 },
      },
    ],
  },
  {
    spotName: "基隆路三段155巷路邊停車格C",     
    point: { lat: 25.015277, lng: 121.542978 }, 
    iconUrl:"", // "https://cdn-icons-png.flaticon.com/512/608/608690.png",
    rects: [
      {
        name: "C01",
        coords: [
          { lat: 25.015333, lng: 121.542936 }, 
          { lat: 25.015236, lng: 121.543009 }, 
          { lat: 25.015263, lng: 121.543044 }, 
          { lat: 25.015360, lng: 121.542971 }, 
        ],
        label: { lat: 25.015319, lng: 121.543030 },
        pano:  { lat: 25.015316, lng: 121.542970 },
      },
    ],
  },
  {
    spotName: "基隆路三段155巷路邊停車格D",     
    point: { lat: 25.015191, lng: 121.542994 }, 
    iconUrl:"", // "https://cdn-icons-png.flaticon.com/512/608/608690.png",
    rects: [
      {
        name: "D01",
...

  {
    ...
    point: { lat: 25.015055, lng: 121.543105 }, 
    iconUrl:"", // "https://cdn-icons-png.flaticon.com/512/608/608690.png",
    rects: [
      {
        name: "E01",
...

  {
    ...
    point: { lat: 25.014505, lng: 121.543557 }, 
    iconUrl:"", // "https://cdn-icons-png.flaticon.com/512/608/608690.png",
    rects: [
      {
        name: "G01",
  ...
  },
  {
    ...
    point: { lat: 25.014125, lng: 121.543870 }, 
    iconUrl:"", // "https://cdn-icons-png.flaticon.com/512/608/608690.png",
    rects: [
      {
        name: "J01",
  ...
  },//-20 -40
  {
    ...
    point: { lat: 25.013718, lng: 121.544194 }, 
    iconUrl:"", // "https://cdn-icons-png.flaticon.com/512/608/608690.png",
    rects: [
      {
        name: "K01",
  ...
  {
    spotName: "基隆路三段155巷路邊停車格L",     
    point: { lat: 25.013495, lng: 121.544358 }, 
    iconUrl:"", // "https://cdn-icons-png.flaticon.com/512/608/608690.png",
    rects: [
      {
        name: "L01",
